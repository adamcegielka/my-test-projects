export const testCase20Data = {
    ...
    verifyProductsSearchedAll: 'Searched Products  Added! Your product has been added to cart. View Cart Contin',
    verifyProductsInCart: 'Product Image Blue Top Women > Tops Rs. 500 1 Rs. 500 '
}